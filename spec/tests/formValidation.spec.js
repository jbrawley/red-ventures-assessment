...
describe('Form Validation', () => {
	...
	//TODO:  Test is flaky, sometimes fails because the submit button is not always clickable
	...
	xit('submit form with invalid data',  function () {
		var formSubmittedAndPassedValidation;
		...
		browser.waitForVisible(LandingPage.checkAvailabilityButtonLocator);
		//click button to submit form, this triggers JS that I cannot get to run when using submitForm();
		LandingPage.clickCheckAvailabilityButton();
		...
		expect(formSubmittedAndPassedValidation).toBe(false);
	});
});